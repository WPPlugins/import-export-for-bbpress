        ...
        class HF_BB_Import_Export_CSV {
            ...
            public function hf_plugin_action_links($links) {
                $plugin_links = array(
                    ...
                    '<a href="https://www.xadapter.com/category/product/bbpress-forum-import-export-plugin-for-wordpress/" target="_blank">' . __('Documentation', 'hf_bb_import_export') . '</a>',
                    '<a href="https://wordpress.org/support/plugin/import-export-for-bbpress" target="_blank">' . __('Support', 'hf_bb_import_export') . '</a>',
'<a href="https://www.xadapter.com/" target="_blank">' . __('Premium Plugins', 'hf_bb_import_export') . '</a>'
                    );
